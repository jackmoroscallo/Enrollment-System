...
{
    public partial class ListOfPendingEnrollment : Form
    {
        public ListOfPendingEnrollment()
        {
            InitializeComponent();
        }
        ...
        private void GetPendingEnrollments(string pSchoolYear, string pSemester)
        {
            ...
            stringBuilder.AppendLine("  WHERE e.[SchoolYear] = @SchoolYear AND e.[Term] = @Term AND e.[EnrollmentStatus] = 'Pending-Registrar'");
        ...
        private void ListOfPendingEnrollment_Load(object sender, EventArgs e)
        {
            getSchoolYear();
            FetchDataAndDisplay();
        }
